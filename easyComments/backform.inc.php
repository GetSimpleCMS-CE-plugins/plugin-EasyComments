...
<form method="post">
    ...
    <input type="text" style="width:100%;padding:10px;box-sizing:border-box;margin-bottom:5px;" value="<?php echo @file_get_contents(GSDATAOTHERPATH . 'easyComments/easyCommentsMail.txt'); ?>" placeholder="" name="adminemail">
    ...
    <input type="text"  name="secretkey" style="width:100%;padding:10px;box-sizing:border-box;margin-bottom:5px;"  value="<?php echo @file_get_contents(GSDATAOTHERPATH . 'easyComments/secretkey.txt'); ?>">
    <label><?php echo i18n_r('easyComments/DOMAINKEY');?></label>
    <input type="text" name="sitekey" style="width:100%;padding:10px;box-sizing:border-box;margin-bottom:5px;" value="<?php echo @file_get_contents(GSDATAOTHERPATH . 'easyComments/sitekey.txt'); ?>">
